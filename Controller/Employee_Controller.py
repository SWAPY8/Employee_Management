...
def update_employee(e_id: int, employee_update: update_struct):
    ...
    e_data = employee_collection.find_one({"e_id": {"$in": [query_id, str(e_id)]}})
    if e_data is None:
        return {"message": "No such employee Exist..."}
    else:
